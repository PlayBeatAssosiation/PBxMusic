...
async def helper_private(
    ...
    if is_callback:
        ...
        await update.reply_sticker("CAACAgUAAxkBAAEBcdpjtOF9R9TIKPS-UMhiwHJVywXqnwACTgYAAgGIqVUJOrEb7kjYoC0E")
    ...
    if cb == "hb9":
        if CallbackQuery.from_user.id not in SUDOERS:
            return await CallbackQuery.answer(
                "ᴛᴇʀɪ ᴍᴀᴀ ᴋɪ ᴄʜᴜᴛ ʙsᴅᴋᴇ😒  ᴛᴇʀᴇ ᴊᴀɪsᴇ ɢᴀɴᴅᴜ ᴋᴏ ᴋᴏɴ ʜɪ sᴜᴅᴏ ᴅᴇɢᴀ😂... ᴄʜᴀʟ ᴀʙʙ ғᴜ*ᴋ ᴏғғ ʜᴏᴊᴀᴀ.", show_alert=True
            )
        else:
