    ...
    if audio_telegram:
        ...
        if await YouTube.exists(url):
            ...
            if (
                ...
                return await mystic.edit_text(
                    "ʜᴀᴀɴ ᴀᴊᴊᴀ ʟᴀɴᴅ ʟᴇʟᴇ ʙsᴅᴋᴇ... ᴛᴇʀᴇᴋᴏ sᴀʙ ᴋᴜᴄʜ ᴄʜᴀʜɪʏᴇ😂 ᴍᴀᴅᴀʀᴄʜᴏᴅ ʏᴏᴜᴛᴜʙᴇ ʟɪɴᴋ ʟᴇᴋʀ ᴀᴀ sᴘᴏᴛɪғʏ ɴʜɪ ᴄʜʟᴇɢᴀ."
                )
            if "track" in url:
                try:
            ...
            try:
                ...
                await mystic.edit_text(
                    "ᴛʜᴇʀᴇ's ᴀɴ ᴇʀʀᴏʀ ɪɴ ᴛʜᴇ ʙᴏᴛ, ᴩʟᴇᴀsᴇ ʀᴇᴩᴏʀᴛ ɪᴛ ᴛᴏ @User_Ankit ᴀs sᴏᴏɴ ᴀs ᴩᴏssɪʙʟᴇ."
                )
